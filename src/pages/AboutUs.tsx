      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-8 text-center">
          <div className="mb-8 mt-20">
            <div className="inline-flex items-center space-x-2 bg-[#9a8457]/20 backdrop-blur-sm rounded-full px-6 py-2 border border-[#9a8457]/50 text-[#9a8457] text-sm font-medium mb-2">
              <Sparkles className="w-4 h-4" />
              <span>Est. with Love • Crafted with Conscience</span>
            </div>
