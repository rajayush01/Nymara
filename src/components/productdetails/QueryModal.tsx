...
const QueryModal: React.FC<QueryModalProps> = ({
  ...
  const handleNextStep = () => {
    if (!hintMessage.trim()) {
      alert("Please add your query or concern in the Additional Notes field");
      return;
    }
    setCurrentStep(2);
  };
        ...
        <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-[#9a8457] to-[#b8a069] text-white p-5">
            ...
            <div className="mt-4 flex items-center space-x-2">
              <div className={`flex-1 h-2 rounded-full ${currentStep >= 1 ? 'bg-white' : 'bg-white/30'}`} />
              <div className={`flex-1 h-2 rounded-full ${currentStep >= 2 ? 'bg-white' : 'bg-white/30'}`} />
            </div>
          </div>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black bg-opacity-60 animate-in fade-in duration-200">
          <div className="bg-white rounded-2xl max-w-sm w-full p-8 shadow-2xl animate-in zoom-in-95 duration-200">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-2">
                Product details have been copied successfully.
              </p>
              <p className="text-sm text-gray-500">
