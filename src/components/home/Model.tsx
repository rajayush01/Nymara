  ...
  return (
    <section className="relative h-screen bg-black overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        >
          <source src={dare} type="video/mp4" />
          <img
      ...
      <div className="relative z-20 h-full flex items-end  justify-center">
        <div className="mb-16 text-center">
          ...
          <button
            ...
            className="group relative overflow-hidden px-8 py-3 bottom-3 border border-white text-white font-light text-sm tracking-[0.2em] transition-all duration-300 hover:bg-white hover:text-black uppercase"
          >
