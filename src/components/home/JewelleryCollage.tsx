      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-4 h-[800px]">
          {collections.map((collection, index) => (
            <div
              ...
              className={`${collection.span} group relative overflow-hidden rounded-lg cursor-pointer`}
            >
              <img
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                ...
                <p className="text-sm text-neutral-200 opacity-0 group-hover:opacity-100 transition-opacity duration-300 delay-100">
        ...
        <div className="text-center mt-12">
          <button 
            ...
            className="px-8 py-3 bg-neutral-900 text-white rounded-full hover:bg-neutral-800 transition-colors duration-300"
          >
